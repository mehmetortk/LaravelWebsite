            ...
            <div class="left">
                <div class="left-top">
                    <div class="user-section">
                        <div class="user-pic"> <img src="{{$user_details->image}}" alt=""> </div>
                        <div class="user-name">
                            <p>{{$user_details->full_name}} </p>
                        </div>
                        <div class="user-role">
                            <p>{{$user_details->role_id}}</p>
                        </div>
                    </div>
                    ...
                    <div class="user-details">
                        ...
                        <div class="user-info">
                            <ul>
                                <li><span>Username:</span> <span> {{$user_details->username}}</span> </li>
                                <li><span>Email:</span> <span>{{$user_details->email}} </span></li>
                                <li><span>Status:</span> <span>{{$user_details->status}} </span></li>
                                <li><span>Role:</span> <span>{{$user_details->role_id}} </span></li>
                                <li><span>Contact:</span> <span> {{$user_details->contact}}</span></li>
                                <li><span>Languages:</span> <span> {{$user_details->language_id}}</span></li>
                                <li><span>Country:</span> <span>{{$country->country_name}} </span></li>
                            </ul>
                        </div>
